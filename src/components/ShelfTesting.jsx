...
export default function ShelfTesting() {
    const {currentStep, setCurrentStep} = useContext(StepControllerContext)
    return(
        ...
        <p className="font-bold text-[#30303c] mb-4 text-xl">Shelf installation and testing</p>
         <div className="mt-4 flex justify-between ">   
            <div className="bg-white shadow-sm rounded-xl flex flex-col p-6 w-1/2 h-[300px] relative">
                ...
                other weights.</p>
                <button className="bg-[#30303C] p-3 text-white text-sm w-1/2 absolute right-6 bottom-6 rounded-full">CONTINUE</button>
            </div>
        ...
        <div className="mr-36">
         ...
         <div className="flex space-x-2 cursor-pointer" onClick={() => setCurrentStep(0)}>
            <Image src={"/left-chevron.png"} alt="previous page" width={20} height={20}></Image>
