...
export default function PreviousButton({ setCurrentStep, stepValue }) {
    return (
        <div className="flex cursor-pointer border-[1px] border-primary p-1 w-44 items-center justify-center space-x-2 rounded-full" onClick={() => setCurrentStep(stepValue)}>
